...
document.addEventListener("DOMContentLoaded", function () {}); // fetchSearchGiphys("puppies").then((res) => console.log(res.data));
...
/*!**************************!*\
  !*** ./util/api_util.js ***!
  \**************************/
/*! exports provided: fetchSearchGiphys, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    APIUtil.fetchSearchGiphys(searchTerm).then(function (giphys) {
      return dispatch(Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_0__["receiveSearchGiphys"])(giphys.data));
    });
  };
};
/* harmony default export */ __webpack_exports__["default"] = (fetchSearchGiphys); // const fetchSuccess = giphys => store.dispatch(receiveSearchGiphys(giphys))fetchSearchGiphys("puppies").then(fetchSuccess);
